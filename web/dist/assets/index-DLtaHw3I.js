const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Login-DfvmKjhC.js","assets/shell-town-Dz19wnHl.js","assets/ZodiacAvatar-BgUFKiIx.js","assets/ZodiacAvatar-CWWkep1L.css","assets/Login-BIvni_ub.css","assets/Layout-D-sZS0my.js","assets/Modal-DiJeCwYw.js","assets/Modal-B5GNjNn6.css","assets/ConfirmDialog-BWQPEwj0.js","assets/ConfirmDialog-CN7bYMZs.css","assets/presets-Dei_6Y9A.js","assets/presets-DcJMZiRz.css","assets/Layout-XCCNX6uo.css","assets/Dashboard-Diz1MmIi.js","assets/Pager-gbjjgpVA.js","assets/Pager-RjBCWJVR.css","assets/GlassCard-DXR0hosh.js","assets/GlassCard-CMdFJEDc.css","assets/PetAvatar-DES9TyqT.js","assets/PetAvatar-zQFKmhKp.css","assets/EmptyState-3g4kc4Z_.js","assets/EmptyState-DBLgpUQ2.css","assets/Dashboard-B_FxzVUT.css","assets/Tasks-Che3Iiq7.js","assets/Tasks-DKM9i3zE.css","assets/Points-CZjWD1SL.js","assets/Points-CN0cT5Na.css","assets/Shop-Du3-DFbo.js","assets/CategoryIcon-Cl8_OLmG.js","assets/CategoryIcon-D-I9Pwwf.css","assets/Shop-5SltuWr8.css","assets/Review-Bfw7P6-M.js","assets/Review-C8mw2Z-n.css","assets/PetSpecies-CRe9V4U2.js","assets/PetSpecies-CcInhvhB.css","assets/Logs-C9S18tzn.js","assets/Logs-DpzpKUrA.css","assets/Layout-CPlDtJA0.js","assets/Layout-oVWCHQXB.css","assets/Home-FlPiYGS3.js","assets/Home-BFDiAmh8.css","assets/Pet-DdDrWqmf.js","assets/Pet-DPhV-drL.css","assets/Tasks-CtUX54oY.js","assets/Tasks-ChNJFXtp.css","assets/Shop-Bv3LjJsL.js","assets/Shop-N0nL9uiL.css","assets/Quiz-BtTISg_G.js","assets/Quiz-51Vs_Ge0.css"])))=>i.map(i=>d[i]);
(function polyfill() {
...
const useAuthStore = /* @__PURE__ */ defineStore("auth", () => {
  const token = /* @__PURE__ */ ref(localStorage.getItem("mj_token"));
  const user = /* @__PURE__ */ ref(
  ...
  async function childLogin(userId, pin) {
    const data = await api.post(
      "/auth/child-login",
      { userId, pin }
    );
...
const KEY = "mj_server";
const DEFAULTS = { useHttps: false, host: "", port: "" };
...
function saveServerConfig(c) {
  localStorage.setItem(KEY, JSON.stringify(c));
}
function hasServerConfig(c) {
  return c.host.trim().length > 0;
}
function serverBaseOrigin() {
...
const api = {
  get: (p2) => request(p2),
  post: (p2, body) => request(p2, { method: "POST", body: JSON.stringify(body ?? {}) }),
  put: (p2, body) => request(p2, { method: "PUT", body: JSON.stringify(body ?? {}) }),
  patch: (p2, body) => request(p2, { method: "PATCH", body: JSON.stringify(body ?? {}) }),
  delete: (p2) => request(p2, { method: "DELETE" }),
  /** 裸文件上传（octet-stream），用于宠物立绘等图片 */
  upload: (p2, file) => request(p2, {
    method: "PUT",
    body: file,
...
const PET_ASSETS_CHANGED = "pet-assets:changed";
...
const useWsStore = /* @__PURE__ */ defineStore("ws", () => {
  ...
  const pendingCount = /* @__PURE__ */ ref(0);
  let socket = null;
  ...
  function connect() {
    ...
    const origin = serverBaseOrigin();
    const proto = (origin == null ? void 0 : origin.startsWith("https")) ? "wss" : "ws";
    ...
    ws.onmessage = (e) => {
      try {
        ...
        if ((msg == null ? void 0 : msg.type) === "pong") {
          clearPongWatchdog();
          return;
        }
        handleMessage(msg);
  ...
  function handleMessage(msg) {
    ...
    const auth = useAuthStore();
    if (msg.type === "new_exchange_request" && ((_a = auth.user) == null ? void 0 : _a.role) === "parent") {
      pendingCount.value++;
      const itemText = msg.exchangeType === "cash" ? `现金 ${msg.amount}元` : `商品「${msg.productName}」`;
    ...
    if (msg.type === "exchange_reviewed" && ((_b = auth.user) == null ? void 0 : _b.role) === "child") {
      const itemText = msg.exchangeType === "cash" ? `${msg.amount}元现金` : `「${msg.productName}」`;
    ...
    if (msg.type === "task_accepted" && ((_c = auth.user) == null ? void 0 : _c.role) === "parent") {
      toast.info(`🤝 ${msg.userName} 接受了任务`);
      window.dispatchEvent(new CustomEvent(WS_EVENTS.taskAccepted, { detail: msg }));
    }
    if (msg.type === "task_completion_submitted" && ((_d = auth.user) == null ? void 0 : _d.role) === "parent") {
    ...
    if (msg.type === "task_review" && ((_e = auth.user) == null ? void 0 : _e.role) === "child") {
      if (msg.status === "approved") {
    ...
    if (msg.type === "task_generated" && ((_f = auth.user) == null ? void 0 : _f.role) === "child") {
      window.dispatchEvent(new CustomEvent(WS_EVENTS.taskGenerated, { detail: msg }));
    }
    if (msg.type === "pet_levelup" && ((_g = auth.user) == null ? void 0 : _g.role) === "parent") {
    ...
    if (msg.type === "pet_fed" && ((_h = auth.user) == null ? void 0 : _h.role) === "child") {
      if (msg.leveledUp) {
  ...
  async function refreshPendingCount() {
    var _a, _b;
    if (((_a = useAuthStore().user) == null ? void 0 : _a.role) !== "parent") return;
    try {
      const r = await api.get("/dashboard");
      pendingCount.value = ((_b = r.pendingReview) == null ? void 0 : _b.total) ?? 0;
    } catch {
    }
  }
  return {
...
const PET_SPECIES_MAP = Object.fromEntries(
  PET_SPECIES.map((s) => [s.key, s])
);
const SERIES_ORDER = ["boy", "girl"];
const SERIES_LABELS = {
  boy: "男生款",
  girl: "女生款"
};
...
function getPetSpecies(key) {
  return key && PET_SPECIES_MAP[key] || PET_SPECIES_MAP.pyro;
}
const STAGE_NAMES = ["神奇蛋", "幼生体", "成长期", "完全体", "究极体"];
const STAGE_EXP = [0, 20, 70, 150, 280];
const DEFAULT_STAGE_EXP = STAGE_EXP;
const MAX_LEVEL = STAGE_EXP.length - 1;
const STAT_META = [
...
function petEffectText(e, empty = "") {
  if (!e) return empty;
  const parts = [];
  if (e.exp) parts.push(`经验+${e.exp}`);
  for (const key of ["satiety", "happiness", "health"]) {
    const v = e[key];
...
const FALLBACK = PET_SPECIES.map((s) => ({
  ...s,
  stageExp: [...DEFAULT_STAGE_EXP],
  isCustom: false
}));
const usePetCatalogStore = /* @__PURE__ */ defineStore("petCatalog", () => {
  const species = /* @__PURE__ */ ref(FALLBACK);
  const loaded = /* @__PURE__ */ ref(false);
  async function load(force = false) {
    if (loaded.value && !force) return;
    try {
      const res = await api.get("/pets/catalog");
...
const BASE = "/".replace(/\/+$/, "");
const PET_ASSET_DIR = "pets";
const PET_ASSET_EXTS = ["webp", "png", "jpg"];
const EGG_ASSET_NAME = "_egg";
const ALL_ASSET_NAME = "all";
function stageFallbackOrder(lv) {
  const order = [lv];
...
function petAssetUrls(speciesKey, level) {
  const lv = Math.max(0, Math.min(MAX_LEVEL, Math.floor(level || 0)));
  if (lv === 0) {
    return [
...
function resolvePetImage(speciesKey, level) {
  const lv = Math.max(0, Math.min(MAX_LEVEL, Math.floor(level || 0)));
      ...
      return openBlock(), createBlock(Teleport, { to: "body" }, [
        createBaseVNode("div", _hoisted_1, [
          createVNode(TransitionGroup, {
            ...
            default: withCtx(() => [
              (openBlock(true), createElementBlock(Fragment, null, renderList(items.value, (t) => {
                return openBlock(), createElementBlock("div", {
                  key: t.id,
                  class: normalizeClass(["toast-item", `t-${t.type}`]),
                  onClick: ($event) => unref(toast).dismiss(t.id)
                }, [
                  createBaseVNode("span", _hoisted_3, toDisplayString(icon(t.type)), 1),
                  createBaseVNode("span", _hoisted_4, toDisplayString(t.message), 1)
                ], 10, _hoisted_2);
              }), 128))
            ]),
            _: 1
...
const ToastHost = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-e0a87dea"]]);
...
const router = createRouter({
  ...
  routes: [
    { path: "/login", name: "login", component: () => __vitePreload(() => import("./Login-DfvmKjhC.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0) },
    // 家长端
    {
      path: "/parent",
      component: () => __vitePreload(() => import("./Layout-D-sZS0my.js"), true ? __vite__mapDeps([5,1,2,3,6,7,8,9,10,11,12]) : void 0),
      meta: { role: "parent" },
      children: [
        { path: "", name: "parent-dashboard", component: () => __vitePreload(() => import("./Dashboard-Diz1MmIi.js"), true ? __vite__mapDeps([13,14,15,16,17,2,3,18,19,20,21,6,7,8,9,10,11,22]) : void 0) },
        { path: "tasks", name: "parent-tasks", component: () => __vitePreload(() => import("./Tasks-Che3Iiq7.js"), true ? __vite__mapDeps([23,16,17,20,21,2,3,6,7,8,9,14,15,24]) : void 0) },
        { path: "points", name: "parent-points", component: () => __vitePreload(() => import("./Points-CZjWD1SL.js"), true ? __vite__mapDeps([25,16,17,2,3,20,21,6,7,8,9,26]) : void 0) },
        { path: "shop", name: "parent-shop", component: () => __vitePreload(() => import("./Shop-Du3-DFbo.js"), true ? __vite__mapDeps([27,16,17,20,21,6,7,28,29,8,9,30]) : void 0) },
        { path: "review", name: "parent-review", component: () => __vitePreload(() => import("./Review-Bfw7P6-M.js"), true ? __vite__mapDeps([31,14,15,16,17,20,21,2,3,6,7,8,9,28,29,32]) : void 0) },
        { path: "pets", name: "parent-pets", component: () => __vitePreload(() => import("./PetSpecies-CRe9V4U2.js"), true ? __vite__mapDeps([33,34]) : void 0) },
        { path: "logs", name: "parent-logs", component: () => __vitePreload(() => import("./Logs-C9S18tzn.js"), true ? __vite__mapDeps([35,14,15,16,17,20,21,36]) : void 0) }
      ]
    },
    // 小孩端
    {
      path: "/child",
      component: () => __vitePreload(() => import("./Layout-CPlDtJA0.js"), true ? __vite__mapDeps([37,1,2,3,6,7,10,11,38]) : void 0),
      meta: { role: "child" },
      children: [
        { path: "", name: "child-home", component: () => __vitePreload(() => import("./Home-FlPiYGS3.js"), true ? __vite__mapDeps([39,14,15,16,17,2,3,18,19,20,21,40]) : void 0) },
        { path: "pet", name: "child-pet", component: () => __vitePreload(() => import("./Pet-DdDrWqmf.js"), true ? __vite__mapDeps([41,14,15,16,17,20,21,28,29,18,19,42]) : void 0) },
        { path: "tasks", name: "child-tasks", component: () => __vitePreload(() => import("./Tasks-CtUX54oY.js"), true ? __vite__mapDeps([43,16,17,20,21,8,9,44]) : void 0) },
        { path: "shop", name: "child-shop", component: () => __vitePreload(() => import("./Shop-Bv3LjJsL.js"), true ? __vite__mapDeps([45,14,15,16,17,20,21,8,9,28,29,46]) : void 0) },
        { path: "quiz", name: "child-quiz", component: () => __vitePreload(() => import("./Quiz-BtTISg_G.js"), true ? __vite__mapDeps([47,16,17,48]) : void 0) }
      ]
    },
    { path: "/", redirect: "/login" },
...
router.beforeEach((to) => {
  ...
  if (role && ((_a = auth.user) == null ? void 0 : _a.role) && role !== auth.user.role) {
...
createApp(_sfc_main).use(createPinia()).use(router).mount("#app");
export {
  usePetCatalogStore as $,
  useWsStore as A,
  onUnmounted as B,
  RouterView as C,
  nextTick as D,
  ...
  vModelCheckbox as H,
  petEffectText as I,
  resolvePetImage as J,
  reactive as K,
  vModelSelect as L,
  DEFAULT_STAGE_EXP as M,
  clearPetAssetCache as N,
  useRoute as O,
  RouterLink as P,
  shallowRef as Q,
  REVIEW_UPDATED as R,
